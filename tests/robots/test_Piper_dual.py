...
def run_dual() -> None:
    ...
    seq = [
        # [R7 ..., L7 ...]
        [0, 0.75, -0.1, 0, 0, 0, 0.96, 0,0.75,-0.1,0,0,0,0.96],
        [0, 0.65, -0.2, 0, 0, 0, 0.66, 0,0.65,-0.2,0,0,0,0.66],
        [0, 0.55, -0.3, 0, 0, 0, 0.36, 0,0.55,-0.3,0,0,0,0.36],
        # [330, -76, 120, -174, 15, -180, 40,330, 76, 120, -173, 15, -180, 40],
        #[330, 76, 120, -173, 15, -180, 40,330, -76, 120, -172, 15, -180, 40],
        #[330, -76, 120, -172, 15, -180, 40,330, 76, 120, -171, 15, -180, 40],
        #[330, 76, 120, -171, 15, -180, 40, 330, -76, 120, -175, 15, -180, 40],
    ]
    try:
        for v in seq:
